...
import { StartSessionDto } from '../../pomodoro/dto/start-session.dto';
import { CompleteSessionDto } from '../../pomodoro/dto/complete-session.dto';
...
export class PomodoroV1Controller {
